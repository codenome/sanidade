	...
	<footer id="footer" class="<?php extra_footer_classes(); ?>">
		...
		<div id="footer-bottom">
			<div class="container">
				...
				<!-- Footer Info -->
				<p id="footer-info"><?php printf( et_get_safe_localization( __( '%1$s', 'extra' ) ), '<a href="http://www.corujito.com" title="Aulas online com a Corujito.com">Corujito 2018</a>' ); ?></p>
